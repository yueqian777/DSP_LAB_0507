...
The normal generated file is `subband_eval_report.csv` in the repository root.
It is ignored by Git so repeated local test runs do not create source changes.
