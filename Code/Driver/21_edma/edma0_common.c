 ...
 * @brief EDMA 回调函数数组
 */
EDMA0_CALLBACK cb_Fxn[EDMA3_NUM_TCC] = {0};

typedef char EDMA0_CallbackTableSizeCheck[
    (sizeof(cb_Fxn) == EDMA3_NUM_TCC * sizeof(cb_Fxn[0])) ? 1 : -1];
