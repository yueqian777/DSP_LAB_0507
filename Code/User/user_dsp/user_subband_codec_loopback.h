...
#define SUBBAND_CODEC_LOOP_LEVEL_HIGH_QUALITY 1
#define SUBBAND_CODEC_LOOP_LEVEL_BALANCED 2
#define SUBBAND_CODEC_LOOP_LEVEL_STRONG 3
#define SUBBAND_CODEC_LOOP_DEFAULT_LEVEL SUBBAND_CODEC_LOOP_LEVEL_BALANCED
...
extern volatile int SUBBAND_CODEC_LOOP_DebugCompressionLevel;
