...
SCRIPT_VERSION = "1.0-harshness-guard"
FRAME_LEN = 1024
PRE_FRAMES = 4
SAMPLE_RATE = 50_000
...
def analyze(result_dir: Path) -> dict[str, object]:
    board_path = result_dir / "harshness_guard_transition_board.json"
...
def main() -> int:
    ...
    json_path = result_dir / "harshness_guard_transition_artifact.json"
    csv_path = result_dir / "harshness_guard_transition_artifact.csv"
