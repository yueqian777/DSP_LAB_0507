...
[ordered]@{
    ...
    input_source = "deterministic PCM16 generated by C6748 and captured from DSP DDR"
...
try {
    foreach ($frequency in $frequencies) {
        ...
        $inputCaptureRaw = Join-Path $frequencyDir "board_input_full.pcm16le"
        ...
        $env:DSP_TEST_CAPTURE_INPUT_RAW = ($inputCaptureRaw -replace '\\', '/')
    ...
    Remove-Item Env:DSP_TEST_ROOT, Env:DSP_TEST_CCXML, Env:DSP_TEST_PROGRAM,
        Env:DSP_TEST_CAPTURE_INPUT_RAW, Env:DSP_TEST_OUTPUT_RAW, Env:DSP_TEST_SUMMARY,
